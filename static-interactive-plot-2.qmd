...
어떤가요? 전반적으로 시간이 지남에 따라 1인당 GDP와 기대수명이 모두 증가한다는 사실을 알 수 있습니다. 그리고 중간중간 급격하게 위치를 바꾸는 포인트도 있습니다. 저한텐 르완다, 캄보디아 등이 눈에 띄네요. 학생들이 경제 수준과 기대수명의 전반적인 상관관계를 탐구하는 한편, 저렇게 눈에 띄는 국가들에 대해 조사해 보는 것도 의미가 있을 것 같습니다. 혹은 전반적인 상관관계를 벗어난 지역(GDP가 높은데 평균 수명이 높지 않다거나, 반대로 GDP는 크게 높지 않은데 평균 수명이 높은 곳)을 찾아보고, 그 원인에 대해 생각해보는 것도 괜찮을 것 같습니다.
